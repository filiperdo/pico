      ...
      <div id="login" class="animate form">
        ...
        <div style="margin:10px 0"><?php if (isset($_GET['st'])) { $objAlerta = new Alerta($_GET['st']); } ?></div>
          <form name="form-login" method="post" action="<?php echo URL?>login/run">
            ...
            <div>
            <button type="submit" class="btn btn-default"><i class="h aak"></i> Login</button>
            ...
            <div class="separator">
              ...
              <br />
              <div>
                <h1><i class="fa fa-gears" style="font-size: 26px;"></i> <?php echo SYSTEM_NAME; ?></h1>
        ...
        <section class="login_content">
          <form>
            ...
            <div class="separator">
              ...
              <br />
              <div>
                <h1><i class="fa fa-paw" style="font-size: 26px;"></i> <?php echo SYSTEM_NAME; ?></h1>
